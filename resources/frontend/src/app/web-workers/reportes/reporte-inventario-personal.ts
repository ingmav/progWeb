...
export class ReporteInventarioPersonal{
    ...
    getDocumentDefinition(reportData:any) {
          ...
          header: {
            ...
            table: {
              ...
              body: [
                ...
                [
                  { text:'' },
                  { text: label_titulo+"\n\nTRABAJADOR:"+persona.descripcion+"\n\nCARGO: "+persona.cargo,             style: "encabezado_principal" },
                  { text:'' },
                ]
              ]
            },
        ...
        let encabezado_lista = [
            ...
            {text: "TIPO MOVIMIENTO",        style: 'cabecera'},
            {text: "CANTIDAD",                style: 'cabecera'},
            {text: "UNIDAD",         style: 'cabecera'},
        ];

        let table_widths = [50, 350, 'auto', 'auto', 'auto'];
        ...
        for(let i = 0; i < total; i++){
            ...
            let item_pdf = [
                { text: item.fecha_movimiento,                          style: 'tabla_datos_center' },
                { text: item.descripcion,               style: 'tabla_datos'        },
                { text: item.tipo_movimiento,           style: 'tabla_datos'        },
                { text: item.cantidad,                style: 'tabla_datos_center' },
                { text: item.abreviatura,        style: 'tabla_datos_center' },
            ];
